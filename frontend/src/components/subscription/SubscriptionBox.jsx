            ...
            >
                <div className="flex-1">
                    <h5 className="text-white font-semibold 3xl:text-4xl md:text-3xl text-xl 3xl:mb-7 mb-5">
                        {!timeTrial ? "Experience PlayCast Free for 7 Days!" : "Unlock Premium Content"}
                    </h5>
                    <p className="text-c-grey-60 3xl:text-[1.36rem] md:text-sm text-xs tracking-wide">
                        {!timeTrial ?
                            "Take advantage of our free trial to explore all the features PlayCast has to offer. Sign up now and start enjoying!" :
